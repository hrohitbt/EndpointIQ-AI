...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    /*
     * Server-verified login. The API issues a short-lived
     * signed session token; nothing about the credential
     * check happens in the browser.
     *
     * Microsoft Entra ID will replace this endpoint call
     * in a later phase without changing the rest of the app.
     */
    ...
    try {
      ...
      localStorage.setItem("endpointiq_token", response.data.token);
      localStorage.setItem("endpointiq_user", response.data.username);
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
          ...
          >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-semibold rounded-xl py-3 transition"
            >
          ...
          <div className="mt-6 bg-slate-50 rounded-xl p-4">
            ...
            <p className="text-xs text-slate-500 text-center">
              ...
              Sessions are verified by the Agent API and expire automatically.
